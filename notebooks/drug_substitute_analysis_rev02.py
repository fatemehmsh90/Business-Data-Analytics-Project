# -*- coding: utf-8 -*-
"""Drug_Substitute_Analysis_Rev02.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NBTnIo-70ooeaA6qxhdCrKKLNJE5fj5j
...
This visual pattern matches earlier medical visualization research, which shows that low-dimensional mapping can reveal hidden treatment relations in large health datasets and help decision-makers understand patterns more easily (Wang et al., 2025).
...
Figure 8.2 shows the subgraph for the first 150 drugs. We can see several tight clusters in the middle of the plot and many small components around the outside. Nodes inside the same small cluster are strong candidates for mutual substitution, because they are connected to each other with many
...
The first limitation is the lack of standard naming between datasets. Brand names, strengths, and local market variations reduced the exact matching accuracy. The second limitation is that MID does not include biological or pharmacokinetic information. Some substitutes are defined by clinical behaviour, not by text or structured fields. Third, the model used a reduced sample (5,000 drugs) for similarity computations due to memory constraints. A full-scale model may give more stable results.

The study also focused on similarity and did not include pricing, availability data, or real shortage events. These factors are important for full supply-chain decision support.

## **9.4	FUTURE RESEARCH DIRECTIONS**

Future projects that could be implemented in the future with the theme of this project include expanding the model with biological data, such as drug mechanisms and gene-target linkages. Adding multilingual text resources may also improve similarity results for non-standard drug names. Another important direction that can be considered in future research is the integration of actual purchase and inventory data of pharmaceutical items in the real market of each country, so that the model can predict shortage events more accurately than the drug market of each country.

Finally, building a full interactive dashboard with real-time updates would turn this system into a practical tool for hospitals, pharmacies, and distributors.
...
12.	Malla, P.S.A. (2025). Data-driven business decision making: leveraging predictive analytics and BI dashboards. Scientiarum: A Multidisciplinary Journal, 1(4), pp. 21–27. [Online]
Available at: https://scientiahub.in/Journal/sapars/article/view/36,
doi: 10.54646/SAPARS.2025.18 [Accepted 4 Aug 2025].

13.	Naveed, S., & Husnain, M. (2025). A drug recommendation system based on response prediction: Integrating gene expression and K-mer fragmentation of drug SMILES using LightGBM. Intelligence-Based Medicine, 11, 100206, [Online] Available at: https://doi.org/10.1016/j.ibmed.2025.100206 [Accepted 27 Jan 2025].

14.	Szymańska, A., Król, M. & Baczyński, K. (2025). Comparative Analysis of Molecular Embeddings for Efficient Compound Similarity Search Using Vector Databases. ChemRxiv, 15(1), [Online] Available at: https://doi.org/10.26434/chemrxiv-2025-zvgwq [Accepted 15 Apr 2025].

15.	Wang, H., Zhang, Y., Li, W., Wei, Z., Wang, Z. & Yang, M. (2025). CLCluster: A redundancy-reduction contrastive learning-based clustering method of cancer subtype based on multi-omics data. Molecular Therapy – Nucleic Acids, 36(2), [Online] Available at: https://doi.org/10.1016/j.omtn.2025.102534 [Accepted 31 Mar 2025].

16.	Wang, T., Codling, D., Msosa, Y.J., Broadbent, M., Kornblum, D., Polling, C., Searle, T., Delaney-Pope, C., Arroyo, B., MacLellan, S., Keddie, Z., Docherty, M., Roberts, A., Stewart, R., McGuire, P., Dobson, R. and Harland, R. (2025). VIEWER: an extensible visual analytics framework for enhancing mental healthcare. Journal of the American Medical Informatics Association, ocaf010. [Online] Available at: https://doi.org/10.1093/jamia/ocaf010 [Accepted 08 Jan 2025].

17.	Yamagiwa, H., Hashimoto, R., Arakane, K., Murakami, K., Soeda, S., Oyama, M., Zhu, Y., Okada, M. & Shimodaira, H. (2025). Predicting Drug–Gene Relations via Analogy Tasks with Word Embeddings. Scientific Reports, 15(17240), [Online] Available at: https://doi.org/10.1038/s41598-025-01418-z [Accessed: 18 May 2025].
"""